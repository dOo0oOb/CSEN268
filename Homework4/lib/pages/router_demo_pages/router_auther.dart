...
//   const RouterAuthor({super.key, required this.bookList, required bool isSortedByAuthor});
//   // const RouterAuthor({super.key, required this.bookList});
...
class RouterAuthor extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Trigger sorting when the page is opened
    context.read<BookBloc>().add(SortByAuthor());
